...
import com.freedomai.projectpn.entity.NPCData;
import com.freedomai.projectpn.entity.NPCDataManager;
...
import com.freedomai.projectpn.renderer.LibrarianNPCEntityRenderer;
import com.freedomai.projectpn.renderer.ProfessorNPCEntityRenderer;
import com.freedomai.projectpn.entity.*;

import java.util.stream.Collectors;

@Mod(ProjectPhoenixNPC.MODID)
public class ProjectPhoenixNPC {
    public static final String MODID = "projectpn";
    ...
    {
        InterModComms.sendTo("projectpn", "helloworld", () -> {
