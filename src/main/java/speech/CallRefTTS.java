...
public class CallRefTTS {
    ...
    public File call(String text,String ref_key) {
        try {
            ...
            refAudioDict.put("朱世平", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/副校长（朱世平）.mp3<text>:对吧大家都知道，是可以的。但是我们也很同学们讲，这个呢，也是，我们说大学里面我们办些讲座，教教大家怎么谈恋爱。谈恋爱有很多规矩的，对不对啊，大家都知道哈，这个非常重要。就是谈恋爱也是一个学术性的东西，所以要。。要要有理论指导，所以呢学校呢以后也会准备一些这个这个呃，seminar，教大家一些基本的东西。我还建议，这个事情不能急，对哇，我是跟你讲，谈恋爱是一门艺术，需要好好琢磨。");
            refAudioDict.put("唐文方", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/人文科学院院长（唐文方）.mp3<text>:我知道现在大家都非常辛苦，正在积极准备高考，我是，嗯，1977年文革以后第一次参加高考，我当时是，那个时候我的心情也非常紧张。但是我们那个时候考试的内容远比现在简单的多，你们现在要考的内容已经比我们当时的知识水平要高出很多很多，所以你们已经很棒了。我给大家的建议就是，高考的时候怎么克服紧张的情绪，是不要过多的去想结果。");
            refAudioDict.put("郑仲煊", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/医学院院长（郑仲煊）en含背景声.mp3<text>:大家好，我是郑仲煊。AI technology is a wonderful question because there are so many in the AI integration. The AI, one of the most important integrations is using AI for doing risk prediction. Using AI for technology, for treatment of patients, able to very precisely doing the right decision treatment. As well, there are technologies for robotics and other multi-modules.");
            refAudioDict.put("戴建岗", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/数据科学院院长(戴建岗)en.mp3<text>:We now live in a time of big data.The intelligent physicians generated by data and arithmetic have become an important component in our daily life.How to create value from secure，fair，data efficient algorithms has become an important challenge faces by every industry in our society.With such background,the school of data science at the Chinese university of Hong Kong,Shenzhen,is established on july fisrt，2020.");
            refAudioDict.put("徐扬生", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/校长（徐扬生）.mp3<text>:我是经常跟同学在那里，额，打交道。我就发现，这个，如果有一个这个同学有点什么问题的话，他推来推去推事情，永远是跟人家要慢半拍的啊，拖拖拉拉的人，对不起，他背后一定有一个事无巨细、什么事情都要管的母亲在那里。我告诉你，我的观察爸爸妈妈两者的话，都有责任。家长在高考这 100 天当中最好的示范作用是什么。");
            refAudioDict.put("唐本忠", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/理工学院院长（唐本忠）.mp3<text>:研究主要是与光有关系，我们看看这个摄影棚，我们就知道光对现代世界是非常非常重要的。从远古到现在，一直都很重要，但是现在的社会就更重要了，因为你现在的通讯是电子通讯，但是以后一定是光子通讯。那就与光有关系，这是从比较实用的角度来讲，我们现在做这个研究叫做聚集诱导发光，聚集诱导发光是什么呢，就是说聚集之后发光更强");
            refAudioDict.put("熊伟", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/经管学院院长（熊伟).mp3<text>:经管的准毕业生同学们，时光飞逝，还有不到一年，你们即将从SME毕业，奔赴新的前程。为了帮助同学们在本科最后一年做好求职、求学的冲刺，SME CDC组织了本次的准毕业生沟通会。一方面，让大家思想上提个醒。充分利用接下来大半年的时间，做好每周每月的规划，一步一步落实到位，直到做到心仪的offer另一方面。通过分析当前求职求学的");
            refAudioDict.put("叶小钢", "/home/sunzhu/Real-time-hyperpersonification/NPC_Ref_audio/采访声音/音乐学院院长（叶小钢).mp3<text>:学生来说，他面临这个世界，我觉得判断和选择是最重要的。为什么，判断包括人生的，生活道路的判断，艺术道路的判断，对学习所用的教材的判断和选择都是非常重要的，这对学生的一生的影响是很大的，觉得大学这个环境培养了什么样的人最合适呢，我觉得每一位学生都应该认识到。我在大学里所要完成的任务是开拓事业，积极进取啊身体");
